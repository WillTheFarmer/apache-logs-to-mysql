...
I volunteer at local nonprofit that provides food and clothing for those in need. The Director is familiar with MySQL and he wanted to import Apache website logs into MySQL tables. At that meeting I knew little about Apache logs but lots about MySQL. I thought it would be a couple days of my time so I offered to research existing solutions. Surprisingly none I found performed any data normalization and were very primitive. The lack of existing solutions led to creation of this solution.
