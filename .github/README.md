...
A complete Web management interface with [apache/echarts](https://github.com/apache/echarts) Log Visualization integration in development. It will be released as a new repository.
