-- Apache 2 License Info -- # comments at start each file ---
...
-- #
-- file: mysql_schema.sql - requires minimum versions MySQL 8.0.41 or MariaDB 10.5.26
-- synopsis: Data Definition (DDL) & Data Manipulation (DML) for MySQL & MariaDB schema for httpLogs2MySQL
-- Script generated from database object scripts ---
-- drop schema --------------------------------------------------------
DROP SCHEMA IF EXISTS `http_logs`;
-- create schema --------------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `http_logs`;
USE `http_logs`;-- Tables below ---
-- # Start of file: access_log_tables.sql ---
-- drop table -----------------------------------------------------------
...
CREATE TABLE `access_log` (
    ...
    added DATETIME NOT NULL DEFAULT NOW()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Table is core table for access logs and contains foreign keys to relate to log attribute tables.';-- # Start of file: error_log_tables.sql ---
-- drop table -----------------------------------------------------------
...
CREATE TABLE `error_log` (
    ...
    importfileid INT NOT NULL,
    added DATETIME NOT NULL DEFAULT NOW()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;-- # Start of file: import_tables.sql ---
-- drop table -----------------------------------------------------------
...
CREATE TABLE `import_error` (
  ...
  added DATETIME NOT NULL DEFAULT NOW()
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='Application Error log. Any errors that occur in MySQL processes will be here. This is a MyISAM engine table to avoid TRANSACTION ROLLBACKS. Always look in this table for problems!';-- # Start of file: log_tables.sql ---
-- drop table -----------------------------------------------------------
...
CREATE TABLE `log_requestlogid` (
    ...
    name VARCHAR(50) NOT NULL,
    added DATETIME NOT NULL DEFAULT NOW()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Table is used by Access and Error logs.';-- Functions below ---
-- # Start of file: access_cookie.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_cookieID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_remoteLogName.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_remoteLogNameID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_remoteUser.sql ---
...
END //
DELIMITER ;
-- # Start of file: access_remoteUserID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_reqMethod.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_reqMethodID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_reqProtocol.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_reqProtocolID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_reqQuery.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_reqQueryID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_reqStatus.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_reqStatusID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_reqUri.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_reqUriID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaBrowser.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaBrowserFamily.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaBrowserFamilyID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaBrowserID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaBrowserVersion.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaBrowserVersionID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaDevice.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaDeviceBrand.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaDeviceBrandID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaDeviceFamily.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaDeviceFamilyID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaDeviceID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaDeviceModel.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaDeviceModelID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaOsFamily.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaOsFamilyID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaOsID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaOsVersion.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_uaOsVersionID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_userAgent.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: access_userAgentID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: clientID_logs.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: clientPortID_logs.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_httpCode.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_httpMessage.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_httpMessageID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_loglevel.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_logLevelID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_logMessage.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_logMessageID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_module.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_moduleID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_process.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_processID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_systemCode.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_systemCodeID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_systemMessage.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_systemMessageID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_thread.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: error_threadID.sql ---
-- drop function -----------------------------------------------------------
...
CREATE DEFINER=`root`@`localhost` FUNCTION `importServerProcessID`
  ...
  READS SQL DATA
BEGIN
  DECLARE passed_importProcess_ID INT DEFAULT NULL;
  DECLARE importProcess_ID INT DEFAULT NULL;
  DECLARE importServer_ID INT DEFAULT NULL;
...
END //
DELIMITER ;
-- # Start of file: log_clientCityID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_clientCoordinateID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_clientCountryID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_clientID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_clientNetworkID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_clientOrganizationID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_clientPort.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_clientPortID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_clientSubdivisionID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_refererID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_requestlog.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_requestLogID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_serverID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_serverPort.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: log_serverPortID.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: refererID_logs.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: requestLogID_logs.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: serverID_logs.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: serverPortID_logs.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: errorProcess.sql ---
-- drop function -----------------------------------------------------------
...
END //
DELIMITER ;
-- # Start of file: import_access_apache.sql ---
-- drop procedure -----------------------------------------------------------
DROP PROCEDURE IF EXISTS `import_access_apache`;
-- create procedure ---------------------------------------------------------
DELIMITER //
CREATE DEFINER = `root`@`localhost` PROCEDURE `import_access_apache`
(
...
BEGIN
  ...
  DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
      ...
      CALL errorProcess('import_access_apache', e1, e2, e3, e4, e5, importLoad_ID, importProcessID);
  ...
  process_import: LOOP
    ...
    VALUES
      (logTimeConverted,
       ...
       importFile_ID);
    IF in_processName = 'csv2mysql' THEN
      UPDATE load_access_csv SET process_status=2 WHERE id=importRecordID;
    ELSEIF in_processName = 'vhost' THEN
      UPDATE load_access_vhost SET process_status=2 WHERE id=importRecordID;
    ELSE
      UPDATE load_access_combined SET process_status=2 WHERE id=importRecordID;
    END IF;
...
END//
DELIMITER ;
-- # Start of file: import_access_nginx.sql ---
-- drop procedure -----------------------------------------------------------
...
BEGIN
 ...
 INNER JOIN import_file f
  ...
  DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
      GET DIAGNOSTICS CONDITION 1 e1 = MYSQL_ERRNO, e2 = MESSAGE_TEXT, e3 = RETURNED_SQLSTATE, e4 = SCHEMA_NAME, e5 = CATALOG_NAME;
      CALL errorProcess('import_error_apache', e1, e2, e3, e4, e5, importLoad_ID, importProcessID);
      SET processErrors = processErrors + 1;
      ROLLBACK;
    END;
  -- check parameters for valid values
...
BEGIN
 ...
 INNER JOIN import_file f
  ...
  DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
      GET DIAGNOSTICS CONDITION 1 e1 = MYSQL_ERRNO, e2 = MESSAGE_TEXT, e3 = RETURNED_SQLSTATE, e4 = SCHEMA_NAME, e5 = CATALOG_NAME;
      CALL errorProcess('import_error_nginx', e1, e2, e3, e4, e5, importLoad_ID, importProcessID);
      SET processErrors = processErrors + 1;
      ROLLBACK;
    END;
  -- check parameters for valid values
  ...
  process_import: LOOP
    ...
    VALUES
       (log_time,
        ...
        requestLog_Id,
        importFile_ID);
    UPDATE load_error_nginx SET process_status=2 WHERE id=importRecordID;
  END LOOP process_import;
  -- to remove SQL calculating loads_processed when importLoad_ID is passed. Set=1 by default.
  IF importLoad_ID IS NOT NULL AND records_processed=0 THEN
    SET loads_processed = 0;
...
END//
DELIMITER ;
-- # Start of file: normalize_client.sql ---
-- drop procedure -----------------------------------------------------------
...
BEGIN
  ...
  DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
      GET DIAGNOSTICS CONDITION 1 e1 = MYSQL_ERRNO, e2 = MESSAGE_TEXT, e3 = RETURNED_SQLSTATE, e4 = SCHEMA_NAME, e5 = CATALOG_NAME;
      CALL errorProcess('normalize_client', e1, e2, e3, e4, e5, importLoad_ID, importProcessID);
      SET processErrors = processErrors + 1;
      ROLLBACK;
    END;
  -- check parameters for valid values
...
END//
DELIMITER ;
-- # Start of file: normalize_useragent.sql ---
-- drop procedure -----------------------------------------------------------
...
END//
DELIMITER ;
-- # Start of file: parse_access_apache.sql ---
-- drop procedure -----------------------------------------------------------
...
END//
DELIMITER ;
-- # Start of file: parse_access_nginx.sql ---
-- drop procedure -----------------------------------------------------------
DROP PROCEDURE IF EXISTS `parse_access_nginx`;
-- create procedure ---------------------------------------------------------
DELIMITER //
CREATE DEFINER = `root`@`localhost` PROCEDURE `parse_access_nginx`
(
  IN in_processName VARCHAR(100),
  IN in_importLoadID VARCHAR(20)
)
BEGIN
  ...
  DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
      GET DIAGNOSTICS CONDITION 1 e1 = MYSQL_ERRNO, e2 = MESSAGE_TEXT, e3 = RETURNED_SQLSTATE, e4 = SCHEMA_NAME, e5 = CATALOG_NAME;
      CALL errorProcess('parse_access_nginx', e1, e2, e3, e4, e5, importLoad_ID, importProcessID);
      SET processErrors = processErrors + 1;
      ROLLBACK;
    END;
  -- check parameters for valid values
  ...
  process_parse: LOOP
    ...
    IF in_processName = 'combined' THEN
      ...
      WHERE id=importRecordID;
    END IF;
    UPDATE load_access_nginx SET process_status=1 WHERE id=importRecordID;
  END LOOP process_parse;
  -- to remove SQL calculating loads_processed when importLoad_ID is passed. Set=1 by default.
  IF importLoad_ID IS NOT NULL AND records_processed=0 THEN
    SET loads_processed = 0;
...
BEGIN
  ...
  DECLARE importRecordID INT DEFAULT NULL;
  DECLARE importFileCheck_ID INT DEFAULT NULL;
  DECLARE importFile_vhost_ID INT DEFAULT NULL;
  DECLARE records_processed INT DEFAULT 0;
  DECLARE files_processed INT DEFAULT 0;
  DECLARE loads_processed INT DEFAULT 1;
  DECLARE processErrors INT DEFAULT 0;
...
--     WHERE id = importRecordID AND LOCATE(' ,', httpmessage)>0 AND server_name IS NULL;
    ...
    UPDATE load_error_apache
     ...
     WHERE id=importRecordID;
    UPDATE load_error_apache SET process_status=1 WHERE id=importRecordID;
  END LOOP process_parse;
  -- to remove SQL calculating loads_processed when importLoad_ID is passed. Set=1 by default.
  IF importLoad_ID IS NOT NULL AND records_processed=0 THEN
    SET loads_processed = 0;
...
BEGIN
  ...
  DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
      GET DIAGNOSTICS CONDITION 1 e1 = MYSQL_ERRNO, e2 = MESSAGE_TEXT, e3 = RETURNED_SQLSTATE, e4 = SCHEMA_NAME, e5 = CATALOG_NAME;
      CALL errorProcess('parse_error_nginx', e1, e2, e3, e4, e5, importLoad_ID, importProcessID);
      SET processErrors = processErrors + 1;
      ROLLBACK;
    END;
  -- check parameters for valid values
...
--     WHERE id = importRecordID AND LOCATE(' ,', httpmessage)>0 AND server_name IS NULL;
    ...
    UPDATE load_error_nginx
       SET module=TRIM(module),
           ...
           request_log_id=TRIM(request_log_id)
     WHERE id=importRecordID;
    UPDATE load_error_nginx SET process_status=1 WHERE id=importRecordID;
  END LOOP process_parse;
  -- to remove SQL calculating loads_processed when importLoad_ID is passed. Set=1 by default.
  IF importLoad_ID IS NOT NULL AND records_processed=0 THEN
    SET loads_processed = 0;
...
DELIMITER ;
-- Views below ---
-- # Start of file: access_log_views.sql ---
-- drop table -----------------------------------------------------------
...
VIEW `access_period_hour_list` AS
   ...
   ORDER BY 'Year',
            ...
            'Day',
            'Hour';
   -- # Start of file: client_views.sql ---
-- drop table -----------------------------------------------------------
...
VIEW `access_client_network_list` AS
 ...
 INNER JOIN `access_log` `l` 
   ...
   GROUP BY `ca`.`name`
   ORDER BY `ca`.`name`;
-- # Start of file: error_log_views.sql ---
-- drop table -----------------------------------------------------------
...
VIEW `error_period_hour_list` AS
   ...
   ORDER BY 'Year',
            ...
            'Day',
            'Hour';
     -- # Start of file: import_views.sql ---
-- drop table -----------------------------------------------------------
...
SELECT `name` AS `Server Port`,
  ...
  FROM `log_serverport`
ORDER BY `name`;
-- # Start of file: useragent_views.sql ---
-- drop table -----------------------------------------------------------
...
VALUES
 ...
 ("csv2mysql"),
 ("error_default"),
 ("error_vhost");-- Indexes, Foreign Keys and Constraints for all Tables below ---
-- UNIQUE Indexes
